...
var SudokuSolver = function (testable) {
  ...
  function boardIsInvalid(boardArray) {
	...
	//checks all the 3 conditions for a valid sudoku
  ...
  function boardIsSolved(boardArray) {
	...
	// all the possible numbers for that cell (all numbers- exisitg possibilities)
  function getNextCellAndPossibilities(boardArray) {
	...
	// all the existing numbers in row, column and box
  ...
  function allBoxesValid(boardArray) {
    return [0, 3, 6, 27, 30, 33, 54, 57, 60].map(function (i) {// starting index of each box
